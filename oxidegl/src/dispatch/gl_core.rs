...
pub unsafe extern "C" fn glActiveShaderProgram(pipeline: GLuint, program: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_active_shader_program(pipeline, program),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glActiveTexture(texture: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_active_texture(unsafe { texture.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glAttachShader(program: GLuint, shader: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_attach_shader(program, shader),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBeginConditionalRender(id: GLuint, mode: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_begin_conditional_render(id, unsafe { mode.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glEndConditionalRender() {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_end_conditional_render(),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBeginQuery(target: GLenum, id: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_begin_query(unsafe { target.into_enum() }, id),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glEndQuery(target: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_end_query(unsafe { target.into_enum() }),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glEndQueryIndexed(target: GLenum, index: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_end_query_indexed(unsafe { target.into_enum() }, index),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glEndTransformFeedback() {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_end_transform_feedback(),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindAttribLocation(program: GLuint, index: GLuint, name: *const GLchar) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_bind_attrib_location(program, index, name) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindBuffer(target: GLenum, buffer: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_buffer(unsafe { target.into_enum() }, buffer),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindBufferBase(target: GLenum, index: GLuint, buffer: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_buffer_base(target, index, buffer),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindBufferRange(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_buffer_range(target, index, buffer, offset, size),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindBuffersBase(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_bind_buffers_base(target, first, count, buffers) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glBindFragDataLocation(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_bind_frag_data_location(program, color, name) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glBindImageTextures(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_bind_image_textures(first, count, textures) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindProgramPipeline(pipeline: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_program_pipeline(pipeline),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glBindSampler(unit: GLuint, sampler: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_sampler(unit, sampler),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindSamplers(first: GLuint, count: GLsizei, samplers: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_bind_samplers(first, count, samplers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindTexture(target: GLenum, texture: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_texture(unsafe { target.into_enum() }, texture),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindTextures(first: GLuint, count: GLsizei, textures: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_bind_textures(first, count, textures) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindTextureUnit(unit: GLuint, texture: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_texture_unit(unit, texture),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindTransformFeedback(target: GLenum, id: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_transform_feedback(target, id),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindVertexArray(array: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_vertex_array(array),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBindVertexBuffer(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_bind_vertex_buffer(bindingindex, buffer, offset, stride),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glVertexArrayVertexBuffers(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe {
            state.oxidegl_vertex_array_vertex_buffers(
...
pub unsafe extern "C" fn glBlendColor(red: GLfloat, green: GLfloat, blue: GLfloat, alpha: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_blend_color(red, green, blue, alpha),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBlendEquation(mode: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_blend_equation(unsafe { mode.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glBlendEquationi(buf: GLuint, mode: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_blend_equationi(buf, unsafe { mode.into_enum() }),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glBufferData(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_buffer_data(target, size, data, usage) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glBufferSubData(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_buffer_sub_data(target, offset, size, data) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glCheckFramebufferStatus(target: GLenum) -> GLenum {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_check_framebuffer_status(unsafe { target.into_enum() }),
    )
}
#[no_mangle]
...
pub unsafe extern "C" fn glClampColor(target: GLenum, clamp: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_clamp_color(target, clamp),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glClear(mask: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_clear(unsafe { mask.into_enum() }),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glClearColor(red: GLfloat, green: GLfloat, blue: GLfloat, alpha: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_clear_color(red, green, blue, alpha),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glClearDepth(depth: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_clear_depth(depth),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glClearDepthf(d: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_clear_depthf(d),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glClearStencil(s: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_clear_stencil(s),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glClientWaitSync(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_client_wait_sync(sync, flags, timeout),
    )
}
#[no_mangle]
...
pub unsafe extern "C" fn glColorMask(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_color_mask(red, green, blue, alpha),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glColorMaski(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_color_maski(index, r, g, b, a),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCompileShader(shader: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_compile_shader(shader),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glCreateBuffers(n: GLsizei, buffers: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_create_buffers(n, buffers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCreateFramebuffers(n: GLsizei, framebuffers: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_create_framebuffers(n, framebuffers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCreateProgram() -> GLuint {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_create_program(),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glCreateProgramPipelines(n: GLsizei, pipelines: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_create_program_pipelines(n, pipelines) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCreateQueries(target: GLenum, n: GLsizei, ids: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_create_queries(target.into_enum(), n, ids) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCreateRenderbuffers(n: GLsizei, renderbuffers: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_create_renderbuffers(n, renderbuffers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCreateSamplers(n: GLsizei, samplers: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_create_samplers(n, samplers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCreateShader(r#type: GLenum) -> GLuint {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_create_shader(unsafe { r#type.into_enum() }),
    )
}
#[no_mangle]
...
pub unsafe extern "C" fn glCreateTextures(target: GLenum, n: GLsizei, textures: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_create_textures(target.into_enum(), n, textures) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCreateTransformFeedbacks(n: GLsizei, ids: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_create_transform_feedbacks(n, ids) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCreateVertexArrays(n: GLsizei, arrays: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_create_vertex_arrays(n, arrays) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glCullFace(mode: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_cull_face(unsafe { mode.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDebugMessageCallback(callback: GLDEBUGPROC, userParam: *const GLvoid) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_debug_message_callback(callback, userParam) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glDeleteBuffers(n: GLsizei, buffers: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_delete_buffers(n, buffers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteFramebuffers(n: GLsizei, framebuffers: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_delete_framebuffers(n, framebuffers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteProgram(program: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_delete_program(program),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteProgramPipelines(n: GLsizei, pipelines: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_delete_program_pipelines(n, pipelines) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteQueries(n: GLsizei, ids: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_delete_queries(n, ids) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteRenderbuffers(n: GLsizei, renderbuffers: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_delete_renderbuffers(n, renderbuffers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteSamplers(count: GLsizei, samplers: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_delete_samplers(count, samplers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteShader(shader: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_delete_shader(shader),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteSync(sync: GLsync) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_delete_sync(sync),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteTextures(n: GLsizei, textures: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_delete_textures(n, textures) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteTransformFeedbacks(n: GLsizei, ids: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_delete_transform_feedbacks(n, ids) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDeleteVertexArrays(n: GLsizei, arrays: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_delete_vertex_arrays(n, arrays) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDepthFunc(func: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_depth_func(unsafe { func.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDepthMask(flag: GLboolean) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_depth_mask(flag),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDepthRange(n: GLdouble, f: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_depth_range(n, f),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDepthRangef(n: GLfloat, f: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_depth_rangef(n, f),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDepthRangeArrayv(first: GLuint, count: GLsizei, v: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_depth_range_arrayv(first, count, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDepthRangeIndexed(index: GLuint, n: GLdouble, f: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_depth_range_indexed(index, n, f),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDetachShader(program: GLuint, shader: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_detach_shader(program, shader),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDispatchCompute(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_dispatch_compute(num_groups_x, num_groups_y, num_groups_z),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDispatchComputeIndirect(indirect: GLintptr) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_dispatch_compute_indirect(indirect),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDrawArrays(mode: GLenum, first: GLint, count: GLsizei) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_draw_arrays(unsafe { mode.into_enum() }, first, count),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDrawArraysIndirect(mode: GLenum, indirect: *const GLvoid) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_draw_arrays_indirect(mode.into_enum(), indirect) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glDrawBuffer(buf: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_draw_buffer(unsafe { buf.into_enum() }),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glDrawBuffers(n: GLsizei, bufs: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_draw_buffers(n, unsafe { bufs.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glNamedFramebufferDrawBuffers(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_named_framebuffer_draw_buffers(framebuffer, n, unsafe {
                bufs.into_enum()
            });
        },
    );
...
pub unsafe extern "C" fn glDrawTransformFeedback(mode: GLenum, id: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_draw_transform_feedback(unsafe { mode.into_enum() }, id),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glDisable(cap: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_disable(unsafe { cap.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glEnable(cap: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_enable(unsafe { cap.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glEnablei(target: GLenum, index: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_enablei(unsafe { target.into_enum() }, index),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDisablei(target: GLenum, index: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_disablei(unsafe { target.into_enum() }, index),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDisableVertexAttribArray(index: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_disable_vertex_attrib_array(index),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glEnableVertexAttribArray(index: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_enable_vertex_attrib_array(index),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glDisableVertexArrayAttrib(vaobj: GLuint, index: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_disable_vertex_array_attrib(vaobj, index),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glEnableVertexArrayAttrib(vaobj: GLuint, index: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_enable_vertex_array_attrib(vaobj, index),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glFenceSync(condition: GLenum, flags: GLenum) -> GLsync {
    ::log::trace!(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_fence_sync(condition, unsafe { flags.into_enum() }),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glFinish() {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_finish(),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glFlushMappedBufferRange(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_flush_mapped_buffer_range(target, offset, length),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glFlushMappedNamedBufferRange(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_flush_mapped_named_buffer_range(buffer, offset, length),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glFrontFace(mode: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_front_face(unsafe { mode.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenBuffers(n: GLsizei, buffers: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_gen_buffers(n, buffers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenerateMipmap(target: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_generate_mipmap(unsafe { target.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenerateTextureMipmap(texture: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_generate_texture_mipmap(texture),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenFramebuffers(n: GLsizei, framebuffers: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_gen_framebuffers(n, framebuffers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenProgramPipelines(n: GLsizei, pipelines: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_gen_program_pipelines(n, pipelines) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenQueries(n: GLsizei, ids: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_gen_queries(n, ids) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenRenderbuffers(n: GLsizei, renderbuffers: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_gen_renderbuffers(n, renderbuffers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenSamplers(count: GLsizei, samplers: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_gen_samplers(count, samplers) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenTextures(n: GLsizei, textures: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_gen_textures(n, textures) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenTransformFeedbacks(n: GLsizei, ids: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_gen_transform_feedbacks(n, ids) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGenVertexArrays(n: GLsizei, arrays: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_gen_vertex_arrays(n, arrays) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetBooleani_v(target: GLenum, index: GLuint, data: *mut GLboolean) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_booleani_v(target.into_enum(), index, data) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetIntegeri_v(target: GLenum, index: GLuint, data: *mut GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_integeri_v(target.into_enum(), index, data) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetInteger64v(pname: GLenum, data: *mut GLint64) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_integer64v(pname.into_enum(), data) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetFloati_v(target: GLenum, index: GLuint, data: *mut GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_floati_v(target.into_enum(), index, data) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetDoublei_v(target: GLenum, index: GLuint, data: *mut GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_doublei_v(target.into_enum(), index, data) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetActiveUniformName(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe {
            state.oxidegl_get_active_uniform_name(
                program,
                uniformIndex,
                bufSize,
                length,
...
pub unsafe extern "C" fn glGetAttribLocation(program: GLuint, name: *const GLchar) -> GLint {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_attrib_location(program, name) },
    )
}
#[no_mangle]
pub unsafe extern "C" fn glGetBufferParameteriv(target: GLenum, pname: GLenum, params: *mut GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_buffer_parameteriv(target, pname, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetBufferParameteri64v(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_buffer_parameteri64v(target, pname, params) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetBufferPointerv(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_buffer_pointerv(target, pname, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetNamedBufferPointerv(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_named_buffer_pointerv(buffer, pname, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetBufferSubData(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_buffer_sub_data(target, offset, size, data) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetError() -> GLenum {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_get_error(),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glGetFragDataIndex(program: GLuint, name: *const GLchar) -> GLint {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_frag_data_index(program, name) },
    )
}
#[no_mangle]
pub unsafe extern "C" fn glGetFragDataLocation(program: GLuint, name: *const GLchar) -> GLint {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_frag_data_location(program, name) },
    )
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetGraphicsResetStatus() -> GLenum {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_get_graphics_reset_status(),
    )
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetMultisamplefv(pname: GLenum, index: GLuint, val: *mut GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_multisamplefv(pname, index, val) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetPointerv(pname: GLenum, params: *mut *mut GLvoid) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_pointerv(pname.into_enum(), params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetProgramiv(program: GLuint, pname: GLenum, params: *mut GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_programiv(program, pname, params) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetQueryBufferObjecti64v(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_get_query_buffer_objecti64v(
                id,
                buffer,
                unsafe { pname.into_enum() },
                offset,
...
pub unsafe extern "C" fn glGetQueryBufferObjectiv(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_get_query_buffer_objectiv(
                id,
                buffer,
                unsafe { pname.into_enum() },
                offset,
...
pub unsafe extern "C" fn glGetQueryBufferObjectuiv(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_get_query_buffer_objectuiv(
                id,
                buffer,
                unsafe { pname.into_enum() },
                offset,
...
pub unsafe extern "C" fn glGetShaderiv(shader: GLuint, pname: GLenum, params: *mut GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_shaderiv(shader, pname.into_enum(), params) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetString(name: GLenum) -> *const GLubyte {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_get_string(unsafe { name.into_enum() }),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glGetStringi(name: GLenum, index: GLuint) -> *const GLubyte {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_get_stringi(unsafe { name.into_enum() }, index),
    )
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetUniformfv(program: GLuint, location: GLint, params: *mut GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_uniformfv(program, location, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetUniformiv(program: GLuint, location: GLint, params: *mut GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_uniformiv(program, location, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetUniformuiv(program: GLuint, location: GLint, params: *mut GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_uniformuiv(program, location, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetUniformdv(program: GLuint, location: GLint, params: *mut GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_uniformdv(program, location, params) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetUniformBlockIndex(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_uniform_block_index(program, uniformBlockName) },
    )
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetUniformLocation(program: GLuint, name: *const GLchar) -> GLint {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_uniform_location(program, name) },
    )
}
#[no_mangle]
...
pub unsafe extern "C" fn glGetVertexAttribdv(index: GLuint, pname: GLenum, params: *mut GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_vertex_attribdv(index, pname, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetVertexAttribfv(index: GLuint, pname: GLenum, params: *mut GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_vertex_attribfv(index, pname, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glGetVertexAttribiv(index: GLuint, pname: GLenum, params: *mut GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_get_vertex_attribiv(index, pname, params) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glInvalidateBufferData(buffer: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_invalidate_buffer_data(buffer),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glInvalidateBufferSubData(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_invalidate_buffer_sub_data(buffer, offset, length),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glInvalidateTexImage(texture: GLuint, level: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_invalidate_tex_image(texture, level),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glIsBuffer(buffer: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_buffer(buffer),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsEnabled(cap: GLenum) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_enabled(unsafe { cap.into_enum() }),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsEnabledi(target: GLenum, index: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_enabledi(unsafe { target.into_enum() }, index),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsFramebuffer(framebuffer: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_framebuffer(framebuffer),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsProgram(program: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_program(program),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsProgramPipeline(pipeline: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_program_pipeline(pipeline),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsQuery(id: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_query(id),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsRenderbuffer(renderbuffer: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_renderbuffer(renderbuffer),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsSampler(sampler: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_sampler(sampler),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsShader(shader: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_shader(shader),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsSync(sync: GLsync) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_sync(sync),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsTexture(texture: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_texture(texture),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsTransformFeedback(id: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_transform_feedback(id),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glIsVertexArray(array: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_is_vertex_array(array),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glLineWidth(width: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_line_width(width),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glLinkProgram(program: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_link_program(program),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glLogicOp(opcode: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_logic_op(unsafe { opcode.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glMapBuffer(target: GLenum, access: GLenum) -> *mut GLvoid {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_map_buffer(target, access),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glMapNamedBuffer(buffer: GLuint, access: GLenum) -> *mut GLvoid {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_map_named_buffer(buffer, access),
    )
}
#[no_mangle]
...
pub unsafe extern "C" fn glMapNamedBufferRange(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_map_named_buffer_range(buffer, offset, length, unsafe {
                access.into_enum()
            })
        },
    )
...
pub unsafe extern "C" fn glMemoryBarrier(barriers: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_memory_barrier(unsafe { barriers.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glMemoryBarrierByRegion(barriers: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_memory_barrier_by_region(unsafe { barriers.into_enum() }),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glMinSampleShading(value: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_min_sample_shading(value),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glObjectPtrLabel(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_object_ptr_label(ptr, length, label) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPatchParameteri(pname: GLenum, value: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_patch_parameteri(unsafe { pname.into_enum() }, value),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPatchParameterfv(pname: GLenum, values: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_patch_parameterfv(pname.into_enum(), values) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPauseTransformFeedback() {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_pause_transform_feedback(),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPixelStoref(pname: GLenum, param: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_pixel_storef(unsafe { pname.into_enum() }, param),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPixelStorei(pname: GLenum, param: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_pixel_storei(unsafe { pname.into_enum() }, param),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPointParameterf(pname: GLenum, param: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_point_parameterf(pname, param),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPointParameterfv(pname: GLenum, params: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_point_parameterfv(pname, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPointParameteri(pname: GLenum, param: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_point_parameteri(pname, param),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPointParameteriv(pname: GLenum, params: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_point_parameteriv(pname, params) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPointSize(size: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_point_size(size),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glPolygonOffset(factor: GLfloat, units: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_polygon_offset(factor, units),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPopDebugGroup() {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_pop_debug_group(),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glPrimitiveRestartIndex(index: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_primitive_restart_index(index),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform1i(program: GLuint, location: GLint, v0: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform1i(program, location, v0),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform1f(program: GLuint, location: GLint, v0: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform1f(program, location, v0),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform1ui(program: GLuint, location: GLint, v0: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform1ui(program, location, v0),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform2i(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform2i(program, location, v0, v1),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform2f(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform2f(program, location, v0, v1),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform2ui(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform2ui(program, location, v0, v1),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform3i(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform3i(program, location, v0, v1, v2),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform3f(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform3f(program, location, v0, v1, v2),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform3ui(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform3ui(program, location, v0, v1, v2),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform4i(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform4i(program, location, v0, v1, v2, v3),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform4f(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform4f(program, location, v0, v1, v2, v3),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform4ui(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform4ui(program, location, v0, v1, v2, v3),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProvokingVertex(mode: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_provoking_vertex(unsafe { mode.into_enum() }),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glQueryCounter(id: GLuint, target: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_query_counter(id, target),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glReadBuffer(src: GLenum) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_read_buffer(unsafe { src.into_enum() }),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glReleaseShaderCompiler() {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_release_shader_compiler(),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glResumeTransformFeedback() {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_resume_transform_feedback(),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glSampleCoverage(value: GLfloat, invert: GLboolean) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_sample_coverage(value, invert),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glSampleMaski(maskNumber: GLuint, mask: GLbitfield) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_sample_maski(maskNumber, mask),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glScissor(x: GLint, y: GLint, width: GLsizei, height: GLsizei) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_scissor(x, y, width, height),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glScissorArrayv(first: GLuint, count: GLsizei, v: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_scissor_arrayv(first, count, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glScissorIndexed(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_scissor_indexed(index, left, bottom, width, height),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glScissorIndexedv(index: GLuint, v: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_scissor_indexedv(index, v) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glShaderSource(
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_shader_source(shader, count, string, length) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glShaderStorageBlockBinding(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_shader_storage_block_binding(
                program,
                storageBlockIndex,
                storageBlockBinding,
            );
...
pub unsafe extern "C" fn glStencilFunc(func: GLenum, r#ref: GLint, mask: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_stencil_func(unsafe { func.into_enum() }, r#ref, mask),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glStencilMask(mask: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_stencil_mask(mask),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glStencilMaskSeparate(face: GLenum, mask: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_stencil_mask_separate(unsafe { face.into_enum() }, mask),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glTextureBarrier() {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_texture_barrier(),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glTransformFeedbackBufferBase(xfb: GLuint, index: GLuint, buffer: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_transform_feedback_buffer_base(xfb, index, buffer),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glUniform1f(location: GLint, v0: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform1f(location, v0),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform2f(location: GLint, v0: GLfloat, v1: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform2f(location, v0, v1),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform3f(location: GLint, v0: GLfloat, v1: GLfloat, v2: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform3f(location, v0, v1, v2),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform4f(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform4f(location, v0, v1, v2, v3),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform1i(location: GLint, v0: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform1i(location, v0),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform2i(location: GLint, v0: GLint, v1: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform2i(location, v0, v1),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform3i(location: GLint, v0: GLint, v1: GLint, v2: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform3i(location, v0, v1, v2),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform4i(location: GLint, v0: GLint, v1: GLint, v2: GLint, v3: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform4i(location, v0, v1, v2, v3),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform1fv(location: GLint, count: GLsizei, value: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform1fv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform2fv(location: GLint, count: GLsizei, value: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform2fv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform3fv(location: GLint, count: GLsizei, value: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform3fv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform4fv(location: GLint, count: GLsizei, value: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform4fv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform1iv(location: GLint, count: GLsizei, value: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform1iv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform2iv(location: GLint, count: GLsizei, value: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform2iv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform3iv(location: GLint, count: GLsizei, value: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform3iv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform4iv(location: GLint, count: GLsizei, value: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform4iv(location, count, value) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glUniform1ui(location: GLint, v0: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform1ui(location, v0),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform2ui(location: GLint, v0: GLuint, v1: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform2ui(location, v0, v1),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform3ui(location: GLint, v0: GLuint, v1: GLuint, v2: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform3ui(location, v0, v1, v2),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform4ui(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform4ui(location, v0, v1, v2, v3),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform1uiv(location: GLint, count: GLsizei, value: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform1uiv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform2uiv(location: GLint, count: GLsizei, value: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform2uiv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform3uiv(location: GLint, count: GLsizei, value: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform3uiv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform4uiv(location: GLint, count: GLsizei, value: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform4uiv(location, count, value) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glUnmapBuffer(target: GLenum) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_unmap_buffer(target),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glUnmapNamedBuffer(buffer: GLuint) -> GLboolean {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_unmap_named_buffer(buffer),
    )
}
#[no_mangle]
pub unsafe extern "C" fn glUseProgram(program: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_use_program(program),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glValidateProgram(program: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_validate_program(program),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glValidateProgramPipeline(pipeline: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_validate_program_pipeline(pipeline),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexArrayElementBuffer(vaobj: GLuint, buffer: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_array_element_buffer(vaobj, buffer),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib1d(index: GLuint, x: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib1d(index, x),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib1dv(index: GLuint, v: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib1dv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib1f(index: GLuint, x: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib1f(index, x),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib1fv(index: GLuint, v: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib1fv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib1s(index: GLuint, x: GLshort) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib1s(index, x),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib1sv(index: GLuint, v: *const GLshort) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib1sv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib2d(index: GLuint, x: GLdouble, y: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib2d(index, x, y),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib2dv(index: GLuint, v: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib2dv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib2f(index: GLuint, x: GLfloat, y: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib2f(index, x, y),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib2fv(index: GLuint, v: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib2fv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib2s(index: GLuint, x: GLshort, y: GLshort) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib2s(index, x, y),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib2sv(index: GLuint, v: *const GLshort) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib2sv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib3d(index: GLuint, x: GLdouble, y: GLdouble, z: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib3d(index, x, y, z),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib3dv(index: GLuint, v: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib3dv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib3f(index: GLuint, x: GLfloat, y: GLfloat, z: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib3f(index, x, y, z),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib3fv(index: GLuint, v: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib3fv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib3s(index: GLuint, x: GLshort, y: GLshort, z: GLshort) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib3s(index, x, y, z),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib3sv(index: GLuint, v: *const GLshort) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib3sv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4Nbv(index: GLuint, v: *const GLbyte) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4_nbv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4Niv(index: GLuint, v: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4_niv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4Nsv(index: GLuint, v: *const GLshort) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4_nsv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4Nub(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib4_nub(index, x, y, z, w),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4Nubv(index: GLuint, v: *const GLubyte) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4_nubv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4Nuiv(index: GLuint, v: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4_nuiv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4Nusv(index: GLuint, v: *const GLushort) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4_nusv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4bv(index: GLuint, v: *const GLbyte) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4bv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4d(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib4d(index, x, y, z, w),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4dv(index: GLuint, v: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4dv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4f(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib4f(index, x, y, z, w),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4fv(index: GLuint, v: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4fv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4iv(index: GLuint, v: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4iv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4s(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib4s(index, x, y, z, w),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4sv(index: GLuint, v: *const GLshort) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4sv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4ubv(index: GLuint, v: *const GLubyte) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4ubv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4uiv(index: GLuint, v: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4uiv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttrib4usv(index: GLuint, v: *const GLushort) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib4usv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI1i(index: GLuint, x: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_i1i(index, x),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI2i(index: GLuint, x: GLint, y: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_i2i(index, x, y),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI3i(index: GLuint, x: GLint, y: GLint, z: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_i3i(index, x, y, z),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI4i(index: GLuint, x: GLint, y: GLint, z: GLint, w: GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_i4i(index, x, y, z, w),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI1ui(index: GLuint, x: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_i1ui(index, x),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI2ui(index: GLuint, x: GLuint, y: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_i2ui(index, x, y),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI3ui(index: GLuint, x: GLuint, y: GLuint, z: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_i3ui(index, x, y, z),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI4ui(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_i4ui(index, x, y, z, w),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI1iv(index: GLuint, v: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i1iv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI2iv(index: GLuint, v: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i2iv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI3iv(index: GLuint, v: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i3iv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI4iv(index: GLuint, v: *const GLint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i4iv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI1uiv(index: GLuint, v: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i1uiv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI2uiv(index: GLuint, v: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i2uiv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI3uiv(index: GLuint, v: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i3uiv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI4uiv(index: GLuint, v: *const GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i4uiv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI4bv(index: GLuint, v: *const GLbyte) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i4bv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI4sv(index: GLuint, v: *const GLshort) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i4sv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI4ubv(index: GLuint, v: *const GLubyte) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i4ubv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribI4usv(index: GLuint, v: *const GLushort) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_i4usv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribP1ui(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_vertex_attrib_p1ui(
                index,
...
pub unsafe extern "C" fn glVertexAttribP2ui(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_vertex_attrib_p2ui(
                index,
                unsafe { r#type.into_enum() },
                normalized,
                value,
...
pub unsafe extern "C" fn glVertexAttribP3ui(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_vertex_attrib_p3ui(
                index,
                unsafe { r#type.into_enum() },
                normalized,
                value,
...
pub unsafe extern "C" fn glVertexAttribP4ui(
    ...
    with_ctx(
        #[inline]
        |mut state| {
            state.oxidegl_vertex_attrib_p4ui(
                index,
                unsafe { r#type.into_enum() },
                normalized,
                value,
...
pub unsafe extern "C" fn glVertexAttribL1d(index: GLuint, x: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_l1d(index, x),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribL2d(index: GLuint, x: GLdouble, y: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_l2d(index, x, y),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribL3d(index: GLuint, x: GLdouble, y: GLdouble, z: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_l3d(index, x, y, z),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribL4d(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_l4d(index, x, y, z, w),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribL1dv(index: GLuint, v: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_l1dv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribL2dv(index: GLuint, v: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_l2dv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribL3dv(index: GLuint, v: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_l3dv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribL4dv(index: GLuint, v: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_vertex_attrib_l4dv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexAttribBinding(attribindex: GLuint, bindingindex: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_binding(attribindex, bindingindex),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glVertexAttribDivisor(index: GLuint, divisor: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_attrib_divisor(index, divisor),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glVertexBindingDivisor(bindingindex: GLuint, divisor: GLuint) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_binding_divisor(bindingindex, divisor),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glVertexArrayBindingDivisor(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_vertex_array_binding_divisor(vaobj, bindingindex, divisor),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glViewport(x: GLint, y: GLint, width: GLsizei, height: GLsizei) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_viewport(x, y, width, height),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glViewportArrayv(first: GLuint, count: GLsizei, v: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_viewport_arrayv(first, count, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glViewportIndexedf(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_viewport_indexedf(index, x, y, w, h),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glViewportIndexedfv(index: GLuint, v: *const GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_viewport_indexedfv(index, v) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glWaitSync(sync: GLsync, flags: GLenum, timeout: GLuint64) {
    ::log::trace!(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_wait_sync(sync, unsafe { flags.into_enum() }, timeout),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glUniform1d(location: GLint, x: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform1d(location, x),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform2d(location: GLint, x: GLdouble, y: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform2d(location, x, y),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform3d(location: GLint, x: GLdouble, y: GLdouble, z: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform3d(location, x, y, z),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform4d(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_uniform4d(location, x, y, z, w),
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform1dv(location: GLint, count: GLsizei, value: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform1dv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform2dv(location: GLint, count: GLsizei, value: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform2dv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform3dv(location: GLint, count: GLsizei, value: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform3dv(location, count, value) },
    );
}
#[no_mangle]
pub unsafe extern "C" fn glUniform4dv(location: GLint, count: GLsizei, value: *const GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| unsafe { state.oxidegl_uniform4dv(location, count, value) },
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform1d(program: GLuint, location: GLint, v0: GLdouble) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform1d(program, location, v0),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform2d(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform2d(program, location, v0, v1),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform3d(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform3d(program, location, v0, v1, v2),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glProgramUniform4d(
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_program_uniform4d(program, location, v0, v1, v2, v3),
    );
}
#[no_mangle]
...
pub unsafe extern "C" fn glPolygonOffsetClamp(factor: GLfloat, units: GLfloat, clamp: GLfloat) {
    ...
    with_ctx(
        #[inline]
        |mut state| state.oxidegl_polygon_offset_clamp(factor, units, clamp),
    );
}
