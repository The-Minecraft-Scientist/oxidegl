...
unsafe extern "C" fn glGetQueryIndexediv(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_get_query_indexediv(target, index, pname, params) })
}
#[no_mangle]
...
unsafe extern "C" fn glGetSamplerParameterIiv(sampler: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_sampler_parameter_iiv(sampler, pname, params) })
}
#[no_mangle]
...
unsafe extern "C" fn glGetTextureParameterIiv(texture: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_texture_parameter_iiv(texture, pname, params) })
}
#[no_mangle]
