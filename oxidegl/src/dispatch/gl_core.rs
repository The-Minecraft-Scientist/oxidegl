...
unsafe extern "C" fn glBufferStorage(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_buffer_storage(target, size, data, flags) });
}
#[no_mangle]
...
unsafe extern "C" fn glClearBufferiv(buffer: GLenum, drawbuffer: GLint, value: *const GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_clear_bufferiv(buffer, drawbuffer, value) });
}
#[no_mangle]
...
unsafe extern "C" fn glClearTexImage(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_clear_tex_image(texture, level, format, r#type, data);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glCreateQueries(target: GLenum, n: GLsizei, ids: *mut GLuint) {
    with_ctx(|mut state| unsafe { state.oxidegl_create_queries(target, n, ids) });
}
#[no_mangle]
...
unsafe extern "C" fn glCreateTextures(target: GLenum, n: GLsizei, textures: *mut GLuint) {
    with_ctx(|mut state| unsafe { state.oxidegl_create_textures(target, n, textures) });
}
#[no_mangle]
...
unsafe extern "C" fn glDrawArraysIndirect(mode: GLenum, indirect: *const GLvoid) {
    with_ctx(|mut state| unsafe { state.oxidegl_draw_arrays_indirect(mode, indirect) });
}
#[no_mangle]
...
unsafe extern "C" fn glDrawBuffers(n: GLsizei, bufs: *const GLenum) {
    with_ctx(|mut state| unsafe { state.oxidegl_draw_buffers(n, bufs) });
}
#[no_mangle]
unsafe extern "C" fn glDrawElements(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_draw_elements(mode, count, r#type, indices) });
}
#[no_mangle]
...
unsafe extern "C" fn glDrawElementsIndirect(mode: GLenum, r#type: GLenum, indirect: *const GLvoid) {
    with_ctx(|mut state| unsafe { state.oxidegl_draw_elements_indirect(mode, r#type, indirect) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetBooleani_v(target: GLenum, index: GLuint, data: *mut GLboolean) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_booleani_v(target, index, data) });
}
#[no_mangle]
unsafe extern "C" fn glGetIntegeri_v(target: GLenum, index: GLuint, data: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_integeri_v(target, index, data) });
}
#[no_mangle]
unsafe extern "C" fn glGetInteger64v(pname: GLenum, data: *mut GLint64) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_integer64v(pname, data) });
}
#[no_mangle]
unsafe extern "C" fn glGetInteger64i_v(target: GLenum, index: GLuint, data: *mut GLint64) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_integer64i_v(target, index, data) });
}
#[no_mangle]
unsafe extern "C" fn glGetFloati_v(target: GLenum, index: GLuint, data: *mut GLfloat) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_floati_v(target, index, data) });
}
#[no_mangle]
unsafe extern "C" fn glGetDoublei_v(target: GLenum, index: GLuint, data: *mut GLdouble) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_doublei_v(target, index, data) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetCompressedTexImage(target: GLenum, level: GLint, img: *mut GLvoid) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_compressed_tex_image(target, level, img) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetFramebufferParameteriv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_framebuffer_parameteriv(target, pname, params);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glGetObjectLabel(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_object_label(identifier, name, bufSize, length, label);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glGetPointerv(pname: GLenum, params: *mut *mut GLvoid) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_pointerv(pname, params) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetProgramPipelineiv(pipeline: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_program_pipelineiv(pipeline, pname, params) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetProgramResourceIndex(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_program_resource_index(program, programInterface, name)
    })
}
#[no_mangle]
...
unsafe extern "C" fn glGetProgramStageiv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_program_stageiv(program, shadertype, pname, values);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetQueryIndexediv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_query_indexediv(target, index, pname, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetQueryiv(target: GLenum, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_queryiv(target, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetQueryObjectiv(id: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_query_objectiv(id, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetQueryObjectuiv(id: GLuint, pname: GLenum, params: *mut GLuint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_query_objectuiv(id, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetQueryObjecti64v(id: GLuint, pname: GLenum, params: *mut GLint64) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_query_objecti64v(id, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetQueryObjectui64v(id: GLuint, pname: GLenum, params: *mut GLuint64) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_query_objectui64v(id, pname, params) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetRenderbufferParameteriv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_renderbuffer_parameteriv(target, pname, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetSamplerParameteriv(sampler: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_sampler_parameteriv(sampler, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetSamplerParameterIiv(sampler: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_sampler_parameter_iiv(sampler, pname, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetSamplerParameterfv(sampler: GLuint, pname: GLenum, params: *mut GLfloat) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_sampler_parameterfv(sampler, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetSamplerParameterIuiv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_sampler_parameter_iuiv(sampler, pname, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetShaderiv(shader: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_shaderiv(shader, pname, params) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetSubroutineIndex(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_get_subroutine_index(program, shadertype, name) })
}
#[no_mangle]
unsafe extern "C" fn glGetSubroutineUniformLocation(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_subroutine_uniform_location(program, shadertype, name)
    })
}
#[no_mangle]
unsafe extern "C" fn glGetSynciv(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_get_synciv(sync, pname, count, length, values) });
}
#[no_mangle]
unsafe extern "C" fn glGetTexImage(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_tex_image(target, level, format, r#type, pixels);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetTexLevelParameterfv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_tex_level_parameterfv(target, level, pname, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetTexParameterfv(target: GLenum, pname: GLenum, params: *mut GLfloat) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_tex_parameterfv(target, pname, params) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetTransformFeedbackiv(xfb: GLuint, pname: GLenum, param: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_transform_feedbackiv(xfb, pname, param) });
}
#[no_mangle]
unsafe extern "C" fn glGetTransformFeedbacki_v(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_transform_feedbacki_v(xfb, pname, index, param);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetTransformFeedbacki64_v(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_transform_feedbacki64_v(xfb, pname, index, param);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glGetUniformSubroutineuiv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_uniform_subroutineuiv(shadertype, location, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetVertexArrayIndexediv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_vertex_array_indexediv(vaobj, index, pname, param);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetVertexArrayIndexed64iv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_vertex_array_indexed64iv(vaobj, index, pname, param);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetVertexArrayiv(vaobj: GLuint, pname: GLenum, param: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_vertex_arrayiv(vaobj, pname, param) });
}
#[no_mangle]
...
unsafe extern "C" fn glInvalidateFramebuffer(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_invalidate_framebuffer(target, numAttachments, attachments);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glMultiDrawArrays(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_multi_draw_arrays(mode, first, count, drawcount) });
}
#[no_mangle]
...
unsafe extern "C" fn glMultiDrawElements(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_multi_draw_elements(mode, count, r#type, indices, drawcount);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glObjectLabel(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_object_label(identifier, name, length, label) });
}
#[no_mangle]
...
unsafe extern "C" fn glPatchParameterfv(pname: GLenum, values: *const GLfloat) {
    with_ctx(|mut state| unsafe { state.oxidegl_patch_parameterfv(pname, values) });
}
#[no_mangle]
...
unsafe extern "C" fn glPushDebugGroup(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_push_debug_group(source, id, length, message) });
}
#[no_mangle]
...
unsafe extern "C" fn glReadPixels(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_read_pixels(x, y, width, height, format, r#type, pixels);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glSamplerParameteriv(sampler: GLuint, pname: GLenum, param: *const GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_sampler_parameteriv(sampler, pname, param) });
}
#[no_mangle]
...
unsafe extern "C" fn glSamplerParameterfv(sampler: GLuint, pname: GLenum, param: *const GLfloat) {
    with_ctx(|mut state| unsafe { state.oxidegl_sampler_parameterfv(sampler, pname, param) });
}
#[no_mangle]
unsafe extern "C" fn glSamplerParameterIiv(sampler: GLuint, pname: GLenum, param: *const GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_sampler_parameter_iiv(sampler, pname, param) });
}
#[no_mangle]
unsafe extern "C" fn glSamplerParameterIuiv(sampler: GLuint, pname: GLenum, param: *const GLuint) {
    with_ctx(|mut state| unsafe { state.oxidegl_sampler_parameter_iuiv(sampler, pname, param) });
}
#[no_mangle]
...
unsafe extern "C" fn glTexParameterfv(target: GLenum, pname: GLenum, params: *const GLfloat) {
    with_ctx(|mut state| unsafe { state.oxidegl_tex_parameterfv(target, pname, params) });
}
#[no_mangle]
...
unsafe extern "C" fn glTextureParameterfv(texture: GLuint, pname: GLenum, param: *const GLfloat) {
    with_ctx(|mut state| unsafe { state.oxidegl_texture_parameterfv(texture, pname, param) });
}
#[no_mangle]
...
unsafe extern "C" fn glUniformSubroutinesuiv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_uniform_subroutinesuiv(shadertype, count, indices);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glTexParameteriv(target: GLenum, pname: GLenum, params: *const GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_tex_parameteriv(target, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetTexParameteriv(target: GLenum, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_tex_parameteriv(target, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetTexLevelParameteriv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_tex_level_parameteriv(target, level, pname, params);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glGetVertexAttribIiv(index: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_vertex_attrib_iiv(index, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetVertexAttribIuiv(index: GLuint, pname: GLenum, params: *mut GLuint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_vertex_attrib_iuiv(index, pname, params) });
}
#[no_mangle]
...
unsafe extern "C" fn glTexParameterIiv(target: GLenum, pname: GLenum, params: *const GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_tex_parameter_iiv(target, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glTexParameterIuiv(target: GLenum, pname: GLenum, params: *const GLuint) {
    with_ctx(|mut state| unsafe { state.oxidegl_tex_parameter_iuiv(target, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetTexParameterIiv(target: GLenum, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_tex_parameter_iiv(target, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetTexParameterIuiv(target: GLenum, pname: GLenum, params: *mut GLuint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_tex_parameter_iuiv(target, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glClearBufferuiv(buffer: GLenum, drawbuffer: GLint, value: *const GLuint) {
    with_ctx(|mut state| unsafe { state.oxidegl_clear_bufferuiv(buffer, drawbuffer, value) });
}
#[no_mangle]
unsafe extern "C" fn glClearBufferfv(buffer: GLenum, drawbuffer: GLint, value: *const GLfloat) {
    with_ctx(|mut state| unsafe { state.oxidegl_clear_bufferfv(buffer, drawbuffer, value) });
}
#[no_mangle]
...
unsafe extern "C" fn glVertexAttribP1uiv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_vertex_attrib_p1uiv(index, r#type, normalized, value);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glVertexAttribP2uiv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_vertex_attrib_p2uiv(index, r#type, normalized, value);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glVertexAttribP3uiv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_vertex_attrib_p3uiv(index, r#type, normalized, value);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glVertexAttribP4uiv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_vertex_attrib_p4uiv(index, r#type, normalized, value);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glGetVertexAttribLdv(index: GLuint, pname: GLenum, params: *mut GLdouble) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_vertex_attrib_ldv(index, pname, params) });
}
#[no_mangle]
...
unsafe extern "C" fn glNamedBufferStorage(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_named_buffer_storage(buffer, size, data, flags) });
}
#[no_mangle]
unsafe extern "C" fn glNamedBufferData(
    ...
    with_ctx(|mut state| unsafe { state.oxidegl_named_buffer_data(buffer, size, data, usage) });
}
#[no_mangle]
...
unsafe extern "C" fn glNamedFramebufferDrawBuffers(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_named_framebuffer_draw_buffers(framebuffer, n, bufs);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glGetNamedFramebufferParameteriv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_named_framebuffer_parameteriv(framebuffer, pname, param);
    });
}
#[no_mangle]
...
unsafe extern "C" fn glTextureParameterIiv(texture: GLuint, pname: GLenum, params: *const GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_texture_parameter_iiv(texture, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glTextureParameterIuiv(texture: GLuint, pname: GLenum, params: *const GLuint) {
    with_ctx(|mut state| unsafe { state.oxidegl_texture_parameter_iuiv(texture, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glTextureParameteriv(texture: GLuint, pname: GLenum, param: *const GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_texture_parameteriv(texture, pname, param) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetTextureLevelParameterfv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_texture_level_parameterfv(texture, level, pname, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetTextureLevelParameteriv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_texture_level_parameteriv(texture, level, pname, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetTextureParameterfv(texture: GLuint, pname: GLenum, params: *mut GLfloat) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_texture_parameterfv(texture, pname, params) });
}
#[no_mangle]
unsafe extern "C" fn glGetTextureParameterIiv(texture: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_texture_parameter_iiv(texture, pname, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetTextureParameterIuiv(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_get_texture_parameter_iuiv(texture, pname, params);
    });
}
#[no_mangle]
unsafe extern "C" fn glGetTextureParameteriv(texture: GLuint, pname: GLenum, params: *mut GLint) {
    with_ctx(|mut state| unsafe { state.oxidegl_get_texture_parameteriv(texture, pname, params) });
}
#[no_mangle]
...
unsafe extern "C" fn glGetnCompressedTexImage(
    ...
    with_ctx(|mut state| unsafe {
        state.oxidegl_getn_compressed_tex_image(target, lod, bufSize, pixels);
    });
}
#[no_mangle]
